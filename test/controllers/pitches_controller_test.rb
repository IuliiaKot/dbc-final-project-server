...
class PitchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pitch" do
    assert_difference('Pitch.count') do
      post pitches_url, params: { pitch: { description: @pitch.description, text: @pitch.text, title: @pitch.title } }, as: :json
    end
  ...
  test "should update pitch" do
    patch pitch_url(@pitch), params: { pitch: { description: @pitch.description, text: @pitch.text, title: @pitch.title } }, as: :json
    assert_response 200
  end
